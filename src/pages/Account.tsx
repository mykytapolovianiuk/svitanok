        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="bg-white rounded-lg shadow border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Будь ласка, увійдіть в акаунт для перегляду профілю
            </p>
            <Link
              to="/auth"
          ...
          <div className="border-b border-black">
            ...
            <button
              onClick={() => setActiveTab('profile')}
                className={`flex-1 py-4 px-6 text-center border-b-2 font-medium text-sm transition-colors uppercase tracking-[1px] ${
                activeTab === 'profile'
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gray-50 border border-gray-200">
                        ...
                        <div>
                          ...
                          <p 
                            ...
                            style={{ fontFamily: 'Montserrat, sans-serif' }}
                          >
                            {formatDateTime(profile.created_at, false)}
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          /* Orders Section */
            ...
            {loading ? (
              ...
              <div className="space-y-4 md:space-y-6">
                {orders.map((order) => (
                      <div key={order.id} className="border border-black rounded-none overflow-hidden bg-white">
                    {/* Order Summary */}
                    <div 
