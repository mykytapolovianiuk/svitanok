            ...
            <>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span
                    className={`text-sm font-medium ${shippingCost === 0 ? 'text-black font-bold' : ''}`}
                    style={{ fontFamily: 'Montserrat, sans-serif' }}
                  >
                ...
                {subtotal < FREE_SHIPPING_THRESHOLD && (
                  <div className="mb-2 p-2 bg-[#FAF4EB] border border-black rounded text-xs text-black text-center" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    Додайте товарів на {(FREE_SHIPPING_THRESHOLD - subtotal).toFixed(2)} ₴ для безкоштовної доставки
                  </div>
                )}
                {subtotal >= FREE_SHIPPING_THRESHOLD && (
                  <div className="mb-2 p-2 bg-black border border-black rounded text-xs text-white text-center font-medium uppercase" style={{ fontFamily: 'Montserrat, sans-serif' }}>
